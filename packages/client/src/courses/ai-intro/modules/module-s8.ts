...
,
    {
      "id": "s8.17",
      "title": "HMM实战——从猜天气到维特比",
      "content": [
        {
          "type": "prose",
          "html": "<p>你被关在一个没有窗户的房间里，只能看到室友每天是带伞还是没带伞出门。你知道下雨天室友大概率带伞、晴天大概率不带。你虽然看不到外面的天气（隐藏状态），但通过观察室友带不带伞（观测），你可以推断今天是晴还是雨。这就是隐马尔可夫模型HMM——从看得见的，猜看不见的。</p>"
        },
        {
          "type": "card",
        ...
        },
        {
          "type": "callout",
          "variant": "warning",
          "text": "期末如果考HMM，大概率是概念题+小计算。前向算法和维特比算法的手算过程要会——不需要记住公式，但要理解αₜ(i)和δₜ(i)的递推思想。\n\n马尔可夫假设：当前状态只依赖于前一个状态。这是HMM一切推导的前提。"
        }
      ]
    }
  ],
